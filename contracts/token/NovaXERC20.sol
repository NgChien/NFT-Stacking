...
contract NovaXERC20 is Context, IERC20, IERC20Metadata, Ownable {
    ...
    function setAddressSellHasTaxFee(
        address account,
        bool hasFee
    ) public onlyOwner {
    ...
    function isAddressSellHasTaxFee(
        address account
    ) public view returns (bool) {
        return _addressSellHasTaxFee[account];
    }

    function setAddressBuyHasTaxFee(
        address account,
        bool hasFee
    ) public onlyOwner {
    ...
    function setAddressBuyExcludeTaxFee(
        address account,
        bool hasFee
    ) public onlyOwner {
    ...
    function setAddressSellExcludeTaxFee(
        address account,
        bool hasFee
    ) public onlyOwner {
    ...
    function calculateSellTaxFee(
        uint256 _amount
    ) private view returns (uint256) {
        return _amount.mul(_taxSellFee).div(10000);
    }

    function calculateBuyTaxFee(
        uint256 _amount
    ) private view returns (uint256) {
